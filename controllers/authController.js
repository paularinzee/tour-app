...
const message = `Forgot your password? Update your password to ${resetURL}.\n If you didn't forget your password,
 ...
 res.status(200).json({
   ...
   message: 'Token sent email!'
    ...
    user.passwordResetToken = udifined;
...
exports.resetPassword = catchAsync(async (req, res, next) => {
    ...
    .update(req.param.token).digest('hex');
